...
description: "The story of building a CANDE mesh editor with artificial intelligence in early 2025, when there was no agent that would read a repository and build a feature, and what it took to get it right."
related:
  - "what-is-cande"
  - "sap2000-ai-tool"
...
I want to be honest about the timeline. I started this in early 2025, when artificial intelligence coding tools were far less capable than they are now. There was no agent that would read a repository and build a feature. There was a chat window, and there was me, and there was a CANDE file format that the model did not understand and a desktop graphical user interface it could not test.
